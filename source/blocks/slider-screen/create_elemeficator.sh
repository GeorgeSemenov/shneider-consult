...
end1
cat slider-screen.pug >> newFile.pug
mv -f newFile.pug  slider-screen.pug
...
end3
cat slider-screen.scss >> newFile.scss
mv -f newFile.scss slider-screen.scss
cd ${fileName}
